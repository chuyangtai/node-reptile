...
+function () {
    ...
    function Platforms(patients, referrals) {
        this.charts = [];
        this.options = [];
        this.doms = [{ id: 'monthBar', sid: 'arrearage', type: 'line', name: '月欠费统计', yName: '元' }, { id: 'distributionBar', sid: 'arrearage', type: 'bar', name: '欠费分布分析-统计', yName: '元' }, { id: 'distributionPe', sid: 'arrearage', type: 'pie', name: '欠费分布分析-占比', yName: '' }, { id: 'YPZEData', type: 'bar', sid: 'medical', name: '药占比', yName: '' }];
...
+function () {
    ...
    Platforms.prototype.getArrearage = function (callback) {
        ...
        return new Promise(function (resolve, reject) {
            axios.get('/arrearageStatistics').then(function (response) {
    ...
    Platforms.prototype.paymentStatistics = function (callback) {
        var pf = this;
        axios.get('/paymentStatistics').then(function (response) {
    ...
    Platforms.prototype.getMedical = function (callback) {
        var pf = this;
        return new Promise(function (resolve, reject) {
            axios.get('/adminDaily').then(function (response) {
    ...
    Platforms.prototype.healthRecords = function (callback) {
        var pf = this;
        axios.get('/healthRecords').then(function (response) {
    ...
    Platforms.prototype.getData = function () {
        ...
        this.getArrearage().then(function (response) {
        ...
        this.getMedical().then(function (response) {
            _this2.doms.forEach(function (o, i) {
                if (o.sid == 'medical') {
                    _this2.updateChart(o.id, response, i);
                    _this2.charts[i].hideLoading();
